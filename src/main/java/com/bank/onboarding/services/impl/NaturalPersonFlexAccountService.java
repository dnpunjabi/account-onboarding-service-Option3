...
@Slf4j
@Service
public class NaturalPersonFlexAccountService  implements CustomerProductService {
    ...
    @Autowired
    public NaturalPersonFlexAccountService (SchufaCheckFeatureImpl schufaCheckFeature,
    ...
    public String process(Map<String, Object> requestContext) throws Exception {
        try {
            ...
            log.info("Successfully completed onboarding for Natural Person Flex Account.");
            return null;
        } catch (Exception ex) {
