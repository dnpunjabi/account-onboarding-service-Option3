...
@Slf4j
@Service
public class LegalEntityFlexAccountService    implements CustomerProductService {
    ...
    @Autowired
    public LegalEntityFlexAccountService  (SchufaCheckFeatureImpl schufaCheckFeature,
    ...
    public String process(Map<String, Object> requestContext) throws Exception {
        try {
            ...
            log.info("Skipping SCHUFA Check for Legal Person Flex Account");
