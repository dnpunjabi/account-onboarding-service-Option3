...
public class LegalEntityProductService implements ProductService {
    ...
    @Autowired
    public LegalEntityProductService(ProductFeatureFactory featureFactory, ProductConfig productConfig, OrinocoCaseManagementService caseManagementService) {
    ...
    public String process(Map<String, Object> requestContext) {
        ...
        try {
            ...
            // Skip schufa-checks for Legal Entities (example rule)
            ...
            if (product.getFeatures().getPinActivation() && pinSet) {
                ...
                log.info("Skipping PIN activation for legal entity or PIN not set.");
            }
